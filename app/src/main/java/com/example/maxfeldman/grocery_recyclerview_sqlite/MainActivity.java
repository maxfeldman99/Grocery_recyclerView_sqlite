...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {  // for swiping and deleting
            @Override
        ...
        }).attachToRecyclerView(recyclerView); // we attach it the item to the recycler view that it will actually work
    ...
    private void removeItem(long id){
        myDataBase.delete(GroceryContract.GroceryEntry.TABLE_NAME, GroceryContract.GroceryEntry._ID + "=" + id,null); // we remove the item (id) that we received from our onSwipe method
        myAdapter.swapCursor(getAllItems());
    }
